"use strict";
cc._RF.push(module, '0c9faw1zJ1LP6OOQtyPy9Hh', 'Navigator');
// Script/Navigator.js
...
var Navigator = function () {
    ...
    _createClass(Navigator, [{
        ...
        value: function navigate(sceneName, parameter, onSceneLaunched) {
            ...
            var readyToLeaveSceneJS = this.getCurrentSceneJS();
        ...
        value: function handleForward(sceneName, parameter) {
            ...
            if (enterSceneJS) {
                ...
                var nextSceneIndex = this._scenesStack.length;
        ...
        key: 'getCurrentSceneJS',
        value: function getCurrentSceneJS() {
            var currentScene = cc.director.getScene();
            if (currentScene) {
                var currentCanvas = currentScene.getChildByName('Canvas');
                if (currentCanvas) {
                    var currentCustomJS = currentCanvas.getComponent(currentScene.name);
                    if (currentCustomJS) {
